...
const orderDb = sequelize.define("orderlists", {
  id: {
  ...
  status: Sequelize.STRING, //staus was in pending state initially when you login and go to orderlist table you can see that staus: pending,paymentId: null
});
