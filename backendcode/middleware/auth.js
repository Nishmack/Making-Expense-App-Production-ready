...
exports.authenticate = async (req, res, next) => {
  try {
    ...
    const user = jwt.verify(token, "fiuhf2bd484fdfhfff656ffhfEwddfkmnv"); //while decrypting we get user obj
    ...
    req.user = data;
    //....global obj.it is common for both function in routes
    //if id:1 in users table in database it will return me entire user details where id=1
